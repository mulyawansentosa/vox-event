        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body" style="overflow-x:auto;padding:20px;">
                    <form method="POST" action="{{ route('admin.v1.organizer.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="organizerName" class="col-md-3 col-form-label text-md-right">{{ __('Organizer Name') }}</label>
                            <div class="col-md-8 mb-3 mb-sm-0">
                                <input id="organizerName" type="text" class="form-control form-control-user @error('organizerName') is-invalid @enderror" name="organizerName" autocomplete="organizerName">
                                @error('organizerName')
