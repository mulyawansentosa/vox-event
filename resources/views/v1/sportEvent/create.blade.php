        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body" style="overflow-x:auto;padding:20px;">
                    <form method="POST" action="{{ route('admin.v1.sport-events.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="eventDate" class="col-md-3 col-form-label text-md-right">{{ __('Event Date') }}</label>
                            <div class="col-md-8 mb-3 mb-sm-0">
                                <input id="eventDate" type="date" class="form-control form-control-user @error('eventDate') is-invalid @enderror" name="eventDate" autocomplete="eventDate">
                                @error('eventDate')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mb-3 mb-sm-0">
                                <input id="eventName" type="text" class="form-control form-control-user @error('eventName') is-invalid @enderror" name="eventName" autocomplete="eventName">
                                @error('eventName')
                                    <span class="invalid-feedback" status="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mb-3 mb-sm-0">
                                <input id="eventType" type="text" class="form-control form-control-user @error('eventType') is-invalid @enderror" name="eventType" autocomplete="eventType">
                                @error('eventType')
                                    <span class="invalid-feedback" status="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mb-3 mb-sm-0">
                                <select name="organizerId" id="organizerId"
                                    class="select2 form-control form-control-user @error('organizerId') is-invalid @enderror" autocomplete="organizerId">
                                    <option value="" selected disabled>Pilih dari daftar</option>
                                    @foreach ($refs as $ref)
                                        <option value="{{ $ref['id'] }}">{{ $ref['organizerName'] }}</option>
                                    @endforeach
                                </select>
                                @error('organizerId')
                                    <span class="invalid-feedback" status="alert">
